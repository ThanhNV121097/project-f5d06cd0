...
## Coverage map
- HELLO-005 AC-1: live hello text from API, not hard-coded
- HELLO-005 AC-2: friendly unreachable error
- HELLO-005 AC-3: hello panel, greeting form, stored greetings list
- SRS non-functional: accessibility labels/focus, responsive no horizontal scroll, visible error copy
- Service contract: page calls API endpoints, list refreshes after submit, form data survives API failure
...
Check: interact_page
Trace: HELLO-005 AC-1, HELLO-005 AC-3
...
Check: render_url
Trace: HELLO-005 AC-3, SRS dependency on backend and database
...
Check: interact_page
Trace: HELLO-005 AC-2, SRS assumption on friendly unreachable copy
...
Check: render_url
Trace: HELLO-002, HELLO-005 AC-1
